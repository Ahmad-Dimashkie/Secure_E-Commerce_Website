...
import { List, ListItemIcon, ListItemText, Button, IconButton } from '@mui/material';
import { Dashboard, ShoppingCart, Store, People, PieChart, Menu, ExitToApp } from '@mui/icons-material';
    ...
    <div className={`sidebar ${isOpen ? 'expanded' : 'collapsed'}`}>
      ...
      <List className="nav-menu">
        <NavLink to="/admin" style={navLinkStyles('/admin')}>
          {({ isActive }) => (
            <>
              <ListItemIcon><Dashboard style={iconStyle(isActive)} /></ListItemIcon>
        ...
        <NavLink to="/admin/orders" style={navLinkStyles('/admin/orders')}>
          {({ isActive }) => (
            <>
              <ListItemIcon><ShoppingCart style={iconStyle(isActive)} /></ListItemIcon>
        ...
        <NavLink to="/admin/products" style={navLinkStyles('/admin/products')}>
          {({ isActive }) => (
            <>
              <ListItemIcon><Store style={iconStyle(isActive)} /></ListItemIcon>
        ...
        <NavLink to="/admin/users" style={navLinkStyles('/admin/users')}>
          {({ isActive }) => (
            <>
              <ListItemIcon><People style={iconStyle(isActive)} /></ListItemIcon>
        ...
        <NavLink to="/admin/sales" style={navLinkStyles('/admin/sales')}>
          {({ isActive }) => (
            <>
              <ListItemIcon><PieChart style={iconStyle(isActive)} /></ListItemIcon>
